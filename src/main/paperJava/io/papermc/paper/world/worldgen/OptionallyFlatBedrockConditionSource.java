...
public record OptionallyFlatBedrockConditionSource(ResourceLocation randomName, VerticalAnchor trueAtAndBelow,
                                                   VerticalAnchor falseAtAndAbove, boolean isRoof)
    // implements SurfaceRules.ConditionSource
{
    ...
    private static final ResourceKey<MapCodec<? extends SurfaceRules.ConditionSource>> CODEC_RESOURCE_KEY = ResourceKey.create(
        ...
        null // ResourceLocation.fromNamespaceAndPath(ResourceLocation.PAPER_NAMESPACE, "optionally_flat_bedrock_condition_source")
        // throw new NotImplementedError();
    );
